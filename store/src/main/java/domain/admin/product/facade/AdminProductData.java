package store.domain.admin.product.info.facade;

import store.domain.admin.product.info.data.DoubleData;
import store.domain.admin.product.info.data.StringData;
